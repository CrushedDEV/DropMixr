                ...
                <div className="space-y-6">
                    ...
                    <form onSubmit={submit} className="space-y-6">
                            ...
                            <div>
                                <p className="text-gray-400 -mt-4 text-sm">
                                    ...
                                    <Link
                                        ...
                                        method="post"
                                        as="button"
                                        className="text-pink-400 underline decoration-pink-500/30 underline-offset-4 transition-colors duration-300 ease-out hover:text-pink-300"
                                    >
                        ...
                        <div className="flex items-center gap-4">
                            <Button disabled={processing} className="bg-gradient-to-r from-pink-600 to-purple-600 hover:from-pink-500 hover:to-purple-500">Guardar</Button>
